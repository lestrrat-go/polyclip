...
**Separately discovered (pre-existing, NOT this fix):** `FuzzUnion` finds a slanted-quad-meets-square case (`a=(-5,-5),(16,-5),(5,5),(-5,5)` ∪ `b=(15,-5),(25,-5),(25,5),(15,5)`) where the union loses ~5 area (returns 150, expected ≥155). Fails identically on the pre-confluence-fix engine, so it is an independent latent bug awaiting its own triage.
